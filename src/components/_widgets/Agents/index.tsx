...
export default function AgentsWidget({ label, value, activeCount, className }: AgentsWidgetProps) {
	return (
		<div
			className={cn(
		...
		>
			...
			<div className="flex items-end justify-between">
				...
				{activeCount && (
					<span className="rounded-full border border-green-100/50 bg-green-50 px-3 py-1.5 text-[11px] font-black text-green-600 shadow-sm">
						{activeCount}
					</span>
				)}
			</div>
